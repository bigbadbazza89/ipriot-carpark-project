...
| ---------- |----------------------------------------|---------------------------------------------------------|
| `CarPark`    | location, plates, total_bays, displays | add_car(), remove_car(), log_activity(), updates_status |
| `Sensor`     | id, active, car_park                   | check_entry(), check_exit()                             |
| `Display`    | message, weather, id, on               | display_cars(), display_message()                       |
